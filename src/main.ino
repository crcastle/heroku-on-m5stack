...
void configModeCallback (WiFiManager *myWiFiManager) {
  ...
  M5.Lcd.println("Connect to wifi SSID");
  M5.Lcd.println(myWiFiManager->getConfigPortalSSID());
  M5.Lcd.println("from phone/computer.");
  M5.Lcd.println();

  M5.Lcd.println("If captive portal");
  M5.Lcd.println("doesn't appear, open");
  M5.Lcd.println(WiFi.softAPIP());
  M5.Lcd.println("in web browser.");
}
...
void setup() {
    ...
    if(!wifiManager.autoConnect()) {
      M5.Lcd.println("failed to connect and hit timeout");
    ...
    M5.Lcd.println("Connected."); M5.Lcd.println();
    M5.Lcd.println("SSID:");
    M5.Lcd.println(WiFi.SSID()); M5.Lcd.println();
    M5.Lcd.println("IP address:");
    M5.Lcd.println(WiFi.localIP()); M5.Lcd.println();
    M5.Lcd.println("Gateway IP:");
    M5.Lcd.println(WiFi.gatewayIP()); M5.Lcd.println();
    M5.Lcd.println("Subnet mask:");
    M5.Lcd.println(WiFi.subnetMask()); M5.Lcd.println();
    M5.Lcd.println("DNS server:");
    M5.Lcd.println(WiFi.dnsIP());  M5.Lcd.println();
